...
def assess_risk(
    ...
    Combines event type, reserve margin, and operator hints into a structured
    risk assessment with severity score (1–5), urgency label, and priority tier.
    ...
    severity = _combine_severity(event_base, reserve_score, severity_hint)
    ...
    assessment: dict[str, Any] = {
        ...
        "scoring_method": "DETERMINISTIC_RULES_v1",
    }
